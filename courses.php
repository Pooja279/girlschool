...
<body>
  ...
  <main id="main" data-aos="fade-in">
    ...
    <div class="breadcrumbs">
      <div class="container">
        <h2>Courses</h2>
        <p>At Our School, we are dedicated to providing a comprehensive and well-rounded education to all of our students. Our broad and balanced curriculum is designed to engage and inspire, with a range of stimulating activities and experiences that prepare our students for success in all aspects of life, including social and cultural contexts.</p>
      </div>
    </div><!-- End Breadcrumbs -->
